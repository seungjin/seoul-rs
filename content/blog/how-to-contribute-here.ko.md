...
블로그(blog) 또는 소식(news)을 작성하려면 [github.com/seoul-rs/seoul-rs](https://github.com/seoul-rs/seoul-rs)를 포크한 후, content 폴더 아래의 blog 또는 news 디렉터리에 마크다운(.md) 파일을 생성하고, 아래 형식의 머리글을 추가한 뒤 작성하고자 하는 내용을 마크다운(Markdown) 형식에 맞게 작성하시면 됩니다. 한글로 작성된 글의 경우, 파일 이름에 `.ko` 언어 구분자를 포함하여 `.ko.md` 형식으로 작성해 주시기 바랍니다. 영어 글의 경우에는 `.ko` 없이 `.md` 확장자만 사용하시면 됩니다.
예: my-first-writing.ko.md(한글), my-first-writing.md(영문)
```
+++
draft = true
title = "seoul.rs에 글써보기"
